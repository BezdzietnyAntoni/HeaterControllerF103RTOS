...
typedef uint8_t menu_config_t [MENU_N_OPTION] ;


const char* menu_config_get_menu_char(menu_option_t menu_option);

const menu_config_t* menu_config_get_default( void );

uint8_t menu_config_get_default_opt( menu_option_t menu_option );

uint8_t menu_config_get_min(menu_option_t menu_option);

uint8_t menu_config_get_max(menu_option_t menu_option);
